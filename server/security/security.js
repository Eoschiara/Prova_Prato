...
app.post(properties.api + '/changePassword', function (req, res) {
    ...
    db_Prova_Prato_db.User.findOne({
...
var createUser = function () {
    ...
    db_Prova_Prato_db = require('../db/Prova_Prato_db_schema.js');
    db_Prova_Prato_db.User.count().exec(function (err, count) {
        if (count == 0) {
            var admin = new db_Prova_Prato_db.User({
                username: 'admin',
